...
> **Archived historical document:** this 2025 progress tracker is no longer the current source of truth. Use `docs/index.md` and `packages/*/docs/*.md` for current package status and behavior.
