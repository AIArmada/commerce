...
> **Archived historical document:** this 2025 architecture vision does not reflect the current package surface area or documentation layout. Prefer `docs/index.md` and `packages/*/docs/*.md` for current reference.
