...
> **Archived legacy guide:** this file documents an older test layout and older commands. Prefer package-local tests, current task scripts, and repo-level tooling already referenced in active docs and composer scripts.
