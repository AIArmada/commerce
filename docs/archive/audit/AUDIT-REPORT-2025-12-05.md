...
> **Archived historical audit:** this report captured a point-in-time review in December 2025 and is not a current defect list. Use active package docs, current tests, and recent audits under `docs/audit/` for present-day verification.
