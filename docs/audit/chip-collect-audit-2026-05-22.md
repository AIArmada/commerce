...
- The Spatie payment integration blueprint now marks its webhook-state analysis as historical baseline context so it no longer contradicts the completed rollout recorded in `docs/archive/spatie-integration/PROGRESS.md`.
