<p align="center">
    <img src="https://raw.githubusercontent.com/aiarmada/cart/main/art/banner.png" alt="AIArmada Commerce" style="width: 100%; max-width: 800px;">
</p>
...
[Read the documentation](docs/index.md) • [Install the suite](docs/01-introduction/02-installation.md#installing-the-commerce-suite) • [Join the discussions](https://github.com/aiarmada/commerce/discussions)
...
AIArmada Commerce is open-sourced software licensed under the [MIT license](LICENSE).
