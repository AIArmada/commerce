...
describe('RoleHierarchyWidget', function (): void {
    ...
    it('builds hierarchy with single root role', function (): void {
        ...
        $perm1 = AIArmada\FilamentAuthz\Models\Permission::create(['name' => 'posts.view', 'guard_name' => 'web']);
        $perm2 = AIArmada\FilamentAuthz\Models\Permission::create(['name' => 'posts.edit', 'guard_name' => 'web']);
    ...
    it('builds hierarchy with nested children', function (): void {
        ...
        $perm1 = AIArmada\FilamentAuthz\Models\Permission::create(['name' => 'all.manage', 'guard_name' => 'web']);
        $perm2 = AIArmada\FilamentAuthz\Models\Permission::create(['name' => 'users.manage', 'guard_name' => 'web']);
        $parentRole->givePermissionTo([$perm1, $perm2]);

        // Create child role with permissions
        $childRole = Role::create(['name' => 'admin', 'guard_name' => 'web']);
        $perm3 = AIArmada\FilamentAuthz\Models\Permission::create(['name' => 'posts.edit', 'guard_name' => 'web']);
    ...
    it('handles multiple root roles', function (): void {
        ...
        $perm1 = AIArmada\FilamentAuthz\Models\Permission::create(['name' => 'admin.manage', 'guard_name' => 'web']);
