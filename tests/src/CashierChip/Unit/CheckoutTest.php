...
it('can create checkout instance from owner and purchase data', function (): void {
    $checkout = new Checkout($this->user, PurchaseData::fromArray(createCheckoutPurchaseData()));
...
it('can create checkout without owner', function (): void {
    $checkout = new Checkout(null, PurchaseData::fromArray(createCheckoutPurchaseData()));
