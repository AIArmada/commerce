...
it('uses explicit short index names to avoid Postgres truncation collisions', function (): void {
    ...
    $supplierLeadTimesPath = $repoRoot . '/packages/inventory/database/migrations/2000_09_01_000013_create_inventory_supplier_leadtimes_table.php';
    $supplierLeadTimes = file_get_contents($supplierLeadTimesPath);

    $reorderSuggestionsPath = $repoRoot . '/packages/inventory/database/migrations/2000_09_01_000014_create_inventory_reorder_suggestions_table.php';
