...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ctext y='.9em' font-size='90'%3E%F0%9F%9B%92%3C/text%3E%3C/svg%3E">
    <title><?php echo e($title ?? 'AIArmada Shop'); ?> - Commerce Demo</title>
...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="<?php echo e(route('shop.home')); ?>" class="flex items-center gap-2">
                        <span class="text-2xl">🛒</span>
                        <span class="font-bold text-xl text-gray-900">AIArmada Shop</span>
                    </a>
                    <div class="hidden md:flex items-center ml-10 space-x-8">
                        <a href="<?php echo e(route('shop.home')); ?>" class="text-gray-600 hover:text-amber-600 font-medium">Home</a>
                        <a href="<?php echo e(route('shop.products')); ?>" class="text-gray-600 hover:text-amber-600 font-medium">Products</a>
                        <a href="<?php echo e(route('shop.categories')); ?>" class="text-gray-600 hover:text-amber-600 font-medium">Categories</a>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="hidden md:block">
                        <form action="<?php echo e(route('shop.products')); ?>" method="GET" class="relative">
                    ...
                    <!-- Cart -->
                    <a href="<?php echo e(route('shop.cart')); ?>" class="relative p-2 text-gray-600 hover:text-amber-600">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" class="flex items-center gap-2 text-gray-600 hover:text-amber-600">
                            <span class="hidden md:inline font-medium"><?php echo e(auth()->user()->name); ?></span>
                        ...
                        <div x-show="open" @click.away="open = false" x-cloak
                            ...
                            <a href="<?php echo e(route('shop.orders')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">My Orders</a>
                            <a href="<?php echo e(route('shop.account')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Account</a>
                            <hr class="my-1">
    ...
    <div class="bg-gradient-to-r from-green-500 to-emerald-600 text-white py-2 px-4 text-center text-sm">
        🎉 You're shopping with affiliate code: <strong><?php echo e(session('affiliate_code')); ?></strong> - Support our partner!
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <footer class="bg-gray-900 text-white mt-16">
        <div class="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400 text-sm">
                        <li><a href="<?php echo e(route('shop.products')); ?>" class="hover:text-white">All Products</a></li>
                        <li><a href="<?php echo e(route('shop.categories')); ?>" class="hover:text-white">Categories</a></li>
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
                <p>&copy; <?php echo e(date('Y')); ?> AIArmada Commerce. Demo for showcase purposes.</p>
                <p class="mt-2">
...
<?php /**PATH /Users/saiffil/Herd/commerce/demo/resources/views/layouts/shop.blade.php ENDPATH**/ ?>