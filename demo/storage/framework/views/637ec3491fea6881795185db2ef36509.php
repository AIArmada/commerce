...
<?php $component = App\View\Components\ShopLayout::resolve(['title' => 'Home'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <section class="bg-gray-900 text-white py-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap items-center justify-center gap-6 text-sm">
                <a href="<?php echo e(route('shop.tracking')); ?>" class="flex items-center gap-2 hover:text-amber-400 transition">
                    <span>📦</span> Track Your Order
                </a>
                <a href="<?php echo e(route('shop.orders')); ?>" class="flex items-center gap-2 hover:text-amber-400 transition">
            ...
            <a href="<?php echo e(route('shop.products', ['category' => $category->slug])); ?>" 
               class="group relative bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition">
                <div class="aspect-square bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                    <span class="text-6xl">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($category->name):
                            case ('Electronics'): ?> 📱 <?php break; ?>
                            <?php case ('Fashion'): ?> 👗 <?php break; ?>
                            <?php case ('Home & Living'): ?> 🏠 <?php break; ?>
                            <?php case ('Sports'): ?> ⚽ <?php break; ?>
                            <?php case ('Beauty'): ?> 💄 <?php break; ?>
                            <?php case ('Books'): ?> 📚 <?php break; ?>
                            <?php default: ?> 📦
                        <?php endswitch; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </span>
                </div>
                <div class="p-4 text-center">
                    <h3 class="font-semibold text-gray-900 group-hover:text-amber-600 transition"><?php echo e($category->name); ?></h3>
                    <p class="text-sm text-gray-500"><?php echo e($category->products_count ?? 0); ?> products</p>
                </div>
            </a>
                ...
                <div class="group bg-white border rounded-2xl overflow-hidden hover:shadow-lg transition">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-xs <?php echo e($product->isInStock() ? 'text-green-600' : 'text-red-600'); ?>">
                                <?php echo e($product->isInStock() ? '✓ In Stock' : '✗ Out of Stock'); ?>

                            </span>
                        </div>
                        <form action="<?php echo e(route('shop.cart.add')); ?>" method="POST" class="mt-3">
                            <?php echo csrf_field(); ?>
    ...
    <section class="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $activeVouchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $voucher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="bg-gradient-to-r from-amber-500 to-orange-500 rounded-2xl p-6 text-white relative overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <p class="text-2xl font-bold font-mono mb-2"><?php echo e($voucher->code); ?></p>
                    <p class="text-lg">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($voucher->type === \AIArmada\Vouchers\Enums\VoucherType::Percentage): ?>
                            <?php echo e(rtrim(rtrim(number_format($voucher->value / 100, 2), '0'), '.')); ?>% OFF
                        <?php elseif($voucher->type === \AIArmada\Vouchers\Enums\VoucherType::Fixed): ?>
                            RM <?php echo e(number_format($voucher->value / 100, 2)); ?> OFF
                        <?php elseif($voucher->type === \AIArmada\Vouchers\Enums\VoucherType::FreeShipping): ?>
                            Free Shipping
                        <?php else: ?>
                            <?php echo e($voucher->type->label()); ?>
                    ...
                    <p class="text-sm text-white/80 mt-2">Min. order: RM <?php echo e(number_format($voucher->min_cart_value / 100, 2)); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($voucher->expires_at): ?>
                    <p class="text-xs text-white/60 mt-2">Expires: <?php echo e($voucher->expires_at->format('M d, Y')); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /Users/saiffil/Herd/commerce/demo/resources/views/shop/home.blade.php ENDPATH**/ ?>