...
return new class extends Migration
{
    ...
    {
        $tableName = config('filament-authz.database.tables.audit_logs', 'authz_audit_logs');
    ...
    {
        Schema::dropIfExists(config('filament-authz.database.tables.audit_logs', 'authz_audit_logs'));
    }
};
