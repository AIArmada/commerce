...
enum TargetingMode: string
{
    ...
    {
        return match ($this) {
            self::All => 'The voucher is valid only when ALL targeting rules are satisfied (AND logic)',
            self::Any => 'The voucher is valid when ANY targeting rule is satisfied (OR logic)',
