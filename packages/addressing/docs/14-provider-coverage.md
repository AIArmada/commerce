...
| Madagascar | MG | 6 | 6 | 144 | 3 | administrative: province > region > district | district, region | ← | Complete — 6 provinces + 24 regions (single table w/ Province column (incl. Ambatosoa 2023)) + 114 districts (INSTAT/Wikipedia; FR↔MG variants mapped; Antananarivo-as-one aggregation per INSTAT RGPH-3 Atlas, legal 119; communes 1,695 per Law 2023-012 annex; fokontany 18,251 per MEF 2015 table) |
...
| Palestine | PS | 16 | 16 | 16 | 1 | administrative: governorate | — | → | L1 — locality admin rows (~500) skipped; Ministry postal table lists zone names but is not a stable administrative locality crosswalk; OCHA COD stops at governorates |
