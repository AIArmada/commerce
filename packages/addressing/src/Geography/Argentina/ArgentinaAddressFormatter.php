...
final class ArgentinaAddressFormatter implements CountryAddressFormatter
{
    ...
    public function format(AddressData $address): string
    {
        ...
        // UPU: CPA postcode to the left of the locality name.
        ...
        if ($address->country !== null && $address->country !== '') {
            ...
            $lines[] = mb_strtoupper($address->countryCode) === 'AR' ? 'Argentina' : $address->countryCode;
        }
