...
class MaldivesGeographyProvider implements CountryAddressAreaMetadataProvider, CountryGeographyProvider, CountryHierarchyProvider
{
    ...
    private const string PROVIDER_KEY = 'aiarmada.addressing.maldives';
    ...
    public function areaRoles(AddressCountry $country): array
    {
        ...
        foreach ($this->addressAreaSource()->areas() as $area) {
            ...
            $roles[$area->sourceId] = array_map(
                static fn (string $role): array => ['role' => $role, 'country_code' => 'MV', 'is_primary' => true],
                $areaRoles,
            );
        }
    ...
    public function addressAreaSource(): AddressAreaSource
    {
        return new CsvAddressAreaSource(
            __DIR__ . '/../../../resources/geography/maldives-address-areas.csv',
            self::AREA_SOURCE,
        );
    }
    ...
    private function stateDefinitions(): array
    {
        return [
            ['name' => 'Addu', 'code' => '01'],
            ['name' => 'Alif Alif', 'code' => '02'],
            ['name' => 'Alif Dhaal', 'code' => '00'],
            ['name' => 'Baa', 'code' => '20'],
            ['name' => 'Dhaalu', 'code' => '17'],
            ['name' => 'Faafu', 'code' => '14'],
