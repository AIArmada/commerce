...
class AlbaniaGeographyProvider implements CountryAddressAreaMetadataProvider, CountryAreaTypeLabelProvider, CountryGeographyProvider, CountryHierarchyProvider
{
    ...
    {
        // Area names use Albanian official forms; qarqe and bashki are the administrative terms.
        return [
            'county' => 'Qark',
            'municipality' => 'Bashki',
        ];
