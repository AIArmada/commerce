...
class CongoGeographyProvider implements CountryAddressAreaMetadataProvider, CountryAreaTypeLabelProvider, CountryGeographyProvider, CountryHierarchyProvider
{
    ...
    private const string PROVIDER_KEY = 'aiarmada.addressing.congo';
    ...
    public function areaRoles(AddressCountry $country): array
    {
        ...
        foreach ($this->addressAreaSource()->areas() as $area) {
            ...
            $roles[$area->sourceId] = array_map(
                static fn (string $role): array => ['role' => $role, 'country_code' => 'CG', 'is_primary' => true],
                $areaRoles,
            );
        }
    ...
    public function addressAreaSource(): AddressAreaSource
    {
        return new CsvAddressAreaSource(
            __DIR__ . '/../../../resources/geography/congo-address-areas.csv',
            self::AREA_SOURCE,
        );
    }
