...
final class EcuadorAddressFormatter implements CountryAddressFormatter
{
    ...
    public function format(AddressData $address): string
    {
        ...
        // UPU: 6 digits left of the locality with a hyphen.
        ...
        if ($address->country !== null && $address->country !== '') {
            ...
            $lines[] = mb_strtoupper($address->countryCode) === 'EC' ? 'Ecuador' : $address->countryCode;
        }
