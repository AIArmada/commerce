...
class AnguillaGeographyProvider implements CountryAddressAreaMetadataProvider, CountryGeographyProvider, CountryHierarchyProvider, CountryPostalCodeNormalizer
{
    ...
    private const string PROVIDER_KEY = 'aiarmada.addressing.anguilla';
    ...
    public function areaRoles(AddressCountry $country): array
    {
        ...
        foreach ($this->addressAreaSource()->areas() as $area) {
            ...
            $roles[$area->sourceId] = array_map(
                static fn (string $role): array => ['role' => $role, 'country_code' => 'AI', 'is_primary' => true],
                $areaRoles,
            );
        }
    ...
    public function addressAreaSource(): AddressAreaSource
    {
        return new CsvAddressAreaSource(
            __DIR__ . '/../../../resources/geography/anguilla-address-areas.csv',
            self::AREA_SOURCE,
        );
    }
    ...
    {
        return [
            ['name' => 'Blowing Point', 'code' => '01'],
            ['name' => 'East End', 'code' => '02'],
            ['name' => 'George Hill', 'code' => '03'],
            ['name' => 'Island Harbour', 'code' => '04'],
            ['name' => 'North Hill', 'code' => '05'],
            ['name' => 'North Side', 'code' => '06'],
            ['name' => 'Sandy Ground', 'code' => '07'],
            ['name' => 'Sandy Hill', 'code' => '08'],
            ['name' => 'South Hill', 'code' => '09'],
            ['name' => 'Stoney Ground', 'code' => '10'],
            ['name' => 'The Farrington', 'code' => '11'],
            ['name' => 'The Quarter', 'code' => '12'],
            ['name' => 'The Valley', 'code' => '13'],
            ['name' => 'West End', 'code' => '14'],
        ];
    }
}
