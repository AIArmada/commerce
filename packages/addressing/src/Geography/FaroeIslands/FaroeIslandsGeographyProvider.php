...
class FaroeIslandsGeographyProvider implements CountryAddressAreaMetadataProvider, CountryAreaTypeLabelProvider, CountryGeographyProvider, CountryHierarchyProvider, CountryPostalCodeNormalizer
{
    public const string AREA_SOURCE = 'aiarmada_addressing_faroe_islands_v1';

    private const string PROVIDER_KEY = 'aiarmada.addressing.faroe_islands';
    ...
    public function areaRoles(AddressCountry $country): array
    {
        ...
        foreach ($this->addressAreaSource()->areas() as $area) {
            ...
            $roles[$area->sourceId] = array_map(
                static fn (string $role): array => ['role' => $role, 'country_code' => 'FO', 'is_primary' => true],
                $areaRoles,
            );
        }
    ...
    public function addressAreaSource(): AddressAreaSource
    {
        return new CsvAddressAreaSource(
            __DIR__ . '/../../../resources/geography/faroe-islands-address-areas.csv',
            self::AREA_SOURCE,
        );
    }
    ...
    {
        return [
            ['name' => 'Eysturoy', 'code' => 'EY'],
            ['name' => 'Northern Isles', 'code' => 'NO'],
            ['name' => 'Sandoy', 'code' => 'SA'],
            ['name' => 'Streymoy', 'code' => 'ST'],
            ['name' => 'Suðuroy', 'code' => 'SU'],
            ['name' => 'Vágar', 'code' => 'VA'],
        ];
    }
}
