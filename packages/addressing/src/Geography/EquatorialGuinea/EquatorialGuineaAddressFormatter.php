...
final class EquatorialGuineaAddressFormatter implements CountryAddressFormatter
{
    ...
    public function format(AddressData $address): string
    {
        ...
        if ($address->country !== null && $address->country !== '') {
            ...
            $lines[] = mb_strtoupper($address->countryCode) === 'GQ' ? 'Equatorial Guinea' : $address->countryCode;
        }
