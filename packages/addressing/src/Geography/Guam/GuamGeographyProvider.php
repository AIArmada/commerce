...
class GuamGeographyProvider implements CountryAddressAreaMetadataProvider, CountryGeographyProvider, CountryHierarchyProvider
{
    ...
    private function stateDefinitions(): array
    {
        return [
            ...
            ['name' => 'Inarajan (Inalåhan)', 'code' => '08'],
            ['name' => 'Mangilao', 'code' => '10'],
            ['name' => 'Merizo (Malesso)', 'code' => '09'],
            ['name' => 'Mongmong-Toto-Maite', 'code' => '11'],
            ['name' => 'Piti', 'code' => '13'],
            ['name' => 'Santa Rita (Sånta Rita-Sumai)', 'code' => '14'],
            ['name' => 'Sinajana', 'code' => '15'],
            ['name' => 'Talofofo (Talo\'fo\'fo)', 'code' => '16'],
            ['name' => 'Tamuning', 'code' => '17'],
            ['name' => 'Umatac (Humåtak)', 'code' => '07'],
            ['name' => 'Yigo', 'code' => '18'],
            ['name' => 'Yona', 'code' => '19'],
        ];
    }
