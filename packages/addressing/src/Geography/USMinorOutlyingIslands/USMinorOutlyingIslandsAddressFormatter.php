...
final class USMinorOutlyingIslandsAddressFormatter implements CountryAddressFormatter
{
    ...
    public function format(AddressData $address): string
    {
        ...
        // UPU: no postcode system (Wake Island mail routes via USPS HI); prints any supplied code on its own line.
        ...
        if ($address->country !== null && $address->country !== '') {
            ...
            $lines[] = mb_strtoupper($address->countryCode) === 'UM' ? 'United States Minor Outlying Islands' : $address->countryCode;
        }
