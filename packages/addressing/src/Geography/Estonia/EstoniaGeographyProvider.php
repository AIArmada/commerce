...
class EstoniaGeographyProvider implements CountryAddressAreaMetadataProvider, CountryAreaTypeLabelProvider, CountryGeographyProvider, CountryHierarchyProvider
{
    ...
    {
        // Estonian administrative terms.
        return [
            'county' => 'Maakond',
            'rural_municipality' => 'Vald',
            'urban_municipality' => 'Linn',
        ];
    }
