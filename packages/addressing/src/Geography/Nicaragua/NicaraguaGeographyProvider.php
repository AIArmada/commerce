...
class NicaraguaGeographyProvider implements CountryAddressAreaMetadataProvider, CountryAreaTypeLabelProvider, CountryGeographyProvider, CountryHierarchyProvider
{
    public const string AREA_SOURCE = 'aiarmada_addressing_nicaragua_v1';

    private const string PROVIDER_KEY = 'aiarmada.addressing.nicaragua';
            ...
            new AddressHierarchyDefinition(
                ...
                levels: [
                    new AddressLevelDefinition(
                        key: 'department',
                        label: 'Department / Autonomous Region',
                        kind: 'state',
    ...
    public function areaRoles(AddressCountry $country): array
    {
        ...
        foreach ($this->addressAreaSource()->areas() as $area) {
            ...
            $roles[$area->sourceId] = array_map(
                static fn (string $role): array => ['role' => $role, 'country_code' => 'NI', 'is_primary' => true],
                $areaRoles,
            );
        }
    ...
    public function addressAreaSource(): AddressAreaSource
    {
        return new CsvAddressAreaSource(
            __DIR__ . '/../../../resources/geography/nicaragua-address-areas.csv',
            self::AREA_SOURCE,
        );
    }
