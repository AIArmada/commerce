...
class KiribatiGeographyProvider implements CountryAddressAreaMetadataProvider, CountryGeographyProvider, CountryHierarchyProvider, CountryPostalCodeNormalizer
{
    ...
    private const string PROVIDER_KEY = 'aiarmada.addressing.kiribati';
    ...
    public function areaRoles(AddressCountry $country): array
    {
        ...
        foreach ($this->addressAreaSource()->areas() as $area) {
            ...
            $roles[$area->sourceId] = array_map(
                static fn (string $role): array => ['role' => $role, 'country_code' => 'KI', 'is_primary' => true],
                $areaRoles,
            );
        }
    ...
    public function addressAreaSource(): AddressAreaSource
    {
        return new CsvAddressAreaSource(
            __DIR__ . '/../../../resources/geography/kiribati-address-areas.csv',
            self::AREA_SOURCE,
        );
    }
