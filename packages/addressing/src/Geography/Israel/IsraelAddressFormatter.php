...
final class IsraelAddressFormatter implements CountryAddressFormatter
{
    ...
    public function format(AddressData $address): string
    {
        ...
        // UPU: 7 digits left of the locality name; legacy 5-digit codes pass through.
        ...
        if ($address->country !== null && $address->country !== '') {
            ...
            $lines[] = mb_strtoupper($address->countryCode) === 'IL' ? 'Israel' : $address->countryCode;
        }
