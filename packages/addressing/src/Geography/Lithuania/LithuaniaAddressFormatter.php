...
final class LithuaniaAddressFormatter implements CountryAddressFormatter
{
    ...
    public function format(AddressData $address): string
    {
        ...
        // UPU: 5 digits left of the locality; intl mail prefixes LT- (supplied as-is).
        ...
        if ($address->country !== null && $address->country !== '') {
            ...
            $lines[] = mb_strtoupper($address->countryCode) === 'LT' ? 'Lithuania' : $address->countryCode;
        }
