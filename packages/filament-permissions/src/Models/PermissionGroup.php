...
class PermissionGroup extends Model
{
    ...
    {
        /** @var string $table */
        $table = config('filament-permissions.database.tables.permission_groups', 'perm_permission_groups');
    ...
    public function permissions(): BelongsToMany
    {
        ...
        $pivotTable = config('filament-permissions.database.tables.permission_group_permission', 'perm_permission_group_permission');
