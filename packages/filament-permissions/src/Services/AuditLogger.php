...
use AIArmada\FilamentPermissions\Jobs\WriteAuditLogJob;
...
class AuditLogger
{
    ...
    {
        return (bool) config('filament-permissions.audit.enabled', true);
    }
    ...
    {
        return (bool) config('filament-permissions.audit.async', false);
    }
