...
use AIArmada\FilamentPermissions\Enums\PolicyCombiningAlgorithm;
use AIArmada\FilamentPermissions\Enums\PolicyDecision;
...
class PolicyEngine
{
    ...
    public function __construct()
    {
        $this->combiningAlgorithm = PolicyCombiningAlgorithm::from(
            config('filament-permissions.policies.combining_algorithm', 'deny-overrides')
        );
    }
