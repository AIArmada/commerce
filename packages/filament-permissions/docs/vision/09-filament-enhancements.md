...
final class PermissionMatrixPage extends Page
{
    ...
    protected static string $view = 'filament-permissions::pages.permission-matrix';
...
final class RoleHierarchyPage extends Page
{
    ...
    protected static string $view = 'filament-permissions::pages.role-hierarchy';
...
final class PermissionSimulatorPage extends Page implements HasForms
{
    ...
    protected static string $view = 'filament-permissions::pages.permission-simulator';
...
{
    protected static string $view = 'filament-permissions::widgets.expiring-permissions';
...
{
    protected static string $view = 'filament-permissions::widgets.recent-audit-activity';
