...
### CLI
- [ ] permissions:cleanup-expired command
...
### CLI
- [ ] permissions:audit-report command
...
### CLI
- [ ] permissions:test-user command
- [ ] permissions:simulate command
- [ ] permissions:impact command
