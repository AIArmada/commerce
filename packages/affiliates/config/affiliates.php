...
return [
    // Database - Tables, prefixes, JSON column types
    'table_names' => [
    ...
    // Credentials/API - Keys, secrets, environment
    'api' => [
    ...
    // Defaults - Currency, tax rates, default values
    'currency' => [
    ...
    // Features/Behavior - Core feature toggles
    'owner' => [
    ...
    'tracking' => [
        ...
        'ip_rate_limit' => [
            'enabled' => env('AFFILIATES_IP_RATE_LIMIT_ENABLED', true),
    ...
    // Integrations - Other package integrations
    'integrations' => [
        'vouchers' => [
