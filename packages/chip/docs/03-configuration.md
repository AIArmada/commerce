...
CHIP does not configure or run document generation or checkout/customer linking. Subscribe to the typed CHIP webhook events in the downstream package that owns those concerns.
