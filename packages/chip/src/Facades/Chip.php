 ...
 * @method static \AIArmada\Chip\Data\PurchaseData createPurchase(array<string, mixed> $data)
 * @method static \AIArmada\Chip\Data\PurchaseData getPurchase(string $id)
 * @method static \AIArmada\Chip\Data\PurchaseData cancelPurchase(string $id)
 * @method static \AIArmada\Chip\Data\PurchaseData|\AIArmada\Chip\Data\PaymentData refundPurchase(string $id, int $amount = null)
 * @method static \AIArmada\Chip\Data\PurchaseData capturePurchase(string $id, int $amount = null)
 * @method static \AIArmada\Chip\Data\PurchaseData releasePurchase(string $id)
 * @method static \AIArmada\Chip\Data\PurchaseData chargePurchase(string $id, string $recurringToken)
 * @method static \AIArmada\Chip\Data\PurchaseData markPurchaseAsPaid(string $id, int $paidOn = null)
 * @method static \AIArmada\Chip\Data\PurchaseData resendInvoice(string $id)
 * @method static \AIArmada\Chip\Data\PurchaseData deleteRecurringToken(string $id)
 * @method static array<string, mixed> getPaymentMethods(array<string, mixed> $filters = [])
 * @method static \AIArmada\Chip\Data\PurchaseData createCheckoutPurchase(array<int, \AIArmada\Chip\Data\ProductData> $products, \AIArmada\Chip\Data\ClientDetailsData $clientDetails, array<string, mixed> $options = [])
 * @method static string getBrandId()
 * @method static \AIArmada\Chip\Data\ClientData createClient(array<string, mixed> $data)
 * @method static \AIArmada\Chip\Data\ClientData getClient(string $id)
 * @method static \AIArmada\Chip\Data\ClientData updateClient(string $id, array<string, mixed> $data)
 * @method static \AIArmada\Chip\Data\ClientData partialUpdateClient(string $id, array<string, mixed> $data)
 ...
 * @method static array<string, mixed> listCompanyStatements(array<string, mixed> $filters = [])
