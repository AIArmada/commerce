...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing($tableName, function (Blueprint $table) use ($jsonType, $tableName): void {
            ...
            $table->string('currency', 3)->default((string) config('cart.money.default_currency', 'MYR'));
        ...
        if (
            commerce_json_column_type('cart', config('cart.database.json_column_type', 'jsonb')) === 'jsonb'
