...
/**
 * @extends Factory<CartSnapshot>
 */
final class CartSnapshotFactory extends Factory
{
    protected $model = CartSnapshot::class;
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'total' => $subtotal,
            'savings' => 0,
            'currency' => (string) config('cart.money.default_currency', 'MYR'),
        ];
    }
