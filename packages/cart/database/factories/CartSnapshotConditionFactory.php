...
/**
 * @extends Factory<CartSnapshotCondition>
 */
final class CartSnapshotConditionFactory extends Factory
{
    /**
     * The name of the factory's corresponding model.
     */
    protected $model = CartSnapshotCondition::class;
    ...
    public function tax(): static
    {
        return $this->state(fn () => [
            ...
            'attributes' => [
                ...
                'tax_region' => $this->faker->stateAbbr(),
            ],
        ]);
    }
    ...
    {
        return $this->state(fn () => [
            'cart_item_id' => CartSnapshotItem::factory(),
