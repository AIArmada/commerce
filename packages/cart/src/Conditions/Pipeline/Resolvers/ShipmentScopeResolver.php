...
final class ShipmentScopeResolver extends AbstractDatasetScopeResolver
{
    protected function scope(): ConditionScope
    {
        return ConditionScope::SHIPMENTS;
    }

    protected function fetchDatasets(ConditionPipelinePhaseContext $phaseContext): iterable
    {
        return $phaseContext->pipelineContext->cartHasShipmentsResolver()
            ? $phaseContext->pipelineContext->getShipments()
            : [];
    }
