...
use AIArmada\Cart\Database\Factories\CartSnapshotConditionFactory;
 ...
 * @property string|null $cart_item_id
 ...
 */
final class CartSnapshotCondition extends Model
{
    /** @use HasFactory<CartSnapshotConditionFactory> */
    use HasFactory;
    ...
    {
        return CartSnapshotConditionFactory::new();
    }

    public function getTable(): string
    {
        return (string) config('cart.database.tables.snapshot_conditions', 'cart_snapshot_conditions');
    }

    /**
     * Get the cart that owns this condition.
     *
     * @return BelongsTo<CartSnapshot, CartSnapshotCondition>
     */
    public function cart(): BelongsTo
    {
        return $this->belongsTo(CartSnapshot::class, 'cart_id');
    }

    /**
     * Get the cart item this condition applies to (if item-level).
     *
     * @return BelongsTo<CartSnapshotItem, CartSnapshotCondition>
     */
    public function cartItem(): BelongsTo
    {
        return $this->belongsTo(CartSnapshotItem::class, 'cart_item_id');
    }
     ...
     * Integer strings already represent minor units; decimal strings use the
     * configured cart rounding mode.
     */
    ...
    {
        return CartMoney::currency($this->cart?->currency);
    }
}
