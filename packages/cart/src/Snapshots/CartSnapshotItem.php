 ...
 */
final class CartSnapshotItem extends Model
{
    /** @use HasFactory<CartSnapshotItemFactory> */
    use HasFactory;
    ...
    {
        return CartSnapshotItemFactory::new();
    }

    public function getTable(): string
    {
        return (string) config('cart.database.tables.snapshot_items', 'cart_snapshot_items');
    }
     ...
     *
     * @return BelongsTo<CartSnapshot, CartSnapshotItem>
     */
    ...
    {
        return CartMoney::majorFromMinor($this->price, $this->cart?->currency);
    }
    ...
    {
        return CartMoney::majorFromMinor($this->subtotal, $this->cart?->currency);
    }
    ...
    {
        LikeSearch::whereLike($query, 'name', LikeSearch::contains($name));
    }
    ...
    {
        return CartMoney::formatMinor($amount, $this->cart?->currency);
    }
}
