 ...
 * @method static self addShipping(string $name, string|int|float $value, \AIArmada\Cart\Conditions\ConditionTarget|string|array|null $target = null, string $method = 'standard', array<string, mixed> $attributes = [])
