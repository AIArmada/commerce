...
class ResourceTransformer
{
    public function transform(string $resourceClass): DiscoveredResource
    {
        return new DiscoveredResource(
            ...
            authz: $this->generatePermissions($resourceClass),
...
class PageTransformer
{
    public function transform(string $pageClass): DiscoveredPage
    {
        ...
        return new DiscoveredPage(
            ...
            authz: ['view' . class_basename($pageClass)],
            metadata: [
...
class WidgetTransformer
{
    public function transform(string $widgetClass): DiscoveredWidget
    {
        return new DiscoveredWidget(
            ...
            authz: ['view' . class_basename($widgetClass)],
            metadata: [
...
php artisan authz:discover

# Discover with options
php artisan authz:discover --panel=admin --type=resources

# Discover and generate permissions
php artisan authz:discover --generate

# Discover and output as JSON
php artisan authz:discover --format=json > entities.json

# Warm up discovery cache
php artisan authz:discover:warmup

# Clear discovery cache
php artisan authz:discover:clear
```

```php
#[AsCommand(name: 'authz:discover')]
