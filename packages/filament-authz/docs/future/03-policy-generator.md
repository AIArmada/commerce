...
php artisan authz:policies

# Generate specific type
php artisan authz:policies --type=abac

# Generate for specific resources
php artisan authz:policies --resource=Post,Comment

# Interactive mode
php artisan authz:policies --interactive

# Force overwrite existing
php artisan authz:policies --force

# Preview without writing
php artisan authz:policies --dry-run

# With custom namespace
php artisan authz:policies --namespace=App\\Policies\\Admin
```

```php
#[AsCommand(name: 'authz:policies')]
class GeneratePoliciesCommand extends Command
{
    public $signature = 'authz:policies
