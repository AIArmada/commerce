...
| `authz:discover` command | High | 2d | EntityDiscoveryService |
...
| Task | Priority | Effort | Dependencies |
|------|----------|--------|--------------|
| `authz:setup` command | High | 3d | Discovery |
...
**Deliverables:**
- [ ] Interactive `authz:setup` wizard
...
| `authz:policies` command | High | 2d | Generator |
...
| `authz:install-trait` command | High | 2d | CodeManipulator |
