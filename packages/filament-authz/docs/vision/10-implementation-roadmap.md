...
Phased implementation roadmap for transforming filament-authz from basic RBAC to an enterprise-grade, ABAC-enabled authorization system.
...
| CLI: authz:groups command | Medium | 4h |
...
| CLI: authz:cleanup-expired | Medium | 4h |
...
| CLI: authz:audit-report | High | 4h |
...
| CLI: authz:test-user | High | 4h |
| CLI: authz:simulate | High | 4h |
| CLI: authz:impact | Medium | 4h |
