...
Complete reference for `config/filament-authz.php`.
...
Run `php artisan authz:sync` to apply changes.
...
```php
'features' => [
    // Enable authz:doctor command
    'doctor' => true,

    // Enable authz:generate-policies command
