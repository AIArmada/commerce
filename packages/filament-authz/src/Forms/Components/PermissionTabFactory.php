...
final class PermissionTabFactory
{
     ...
     * @return array<string, string>
     */
    public static function localizePermissions(array $permissions): array
    {
        $plugin = static::getPlugin();
     ...
     */
    public static function groupByPackage(Collection $items): Collection
    {
        return $items
    ...
    public static function extractPackageName(string $class): string
    {
