...
final class ResolveAccessibleExperiment
{
    public function handle(Experiment | string $experiment, string $message = 'Growth experiment is not accessible in the current owner scope.'): Experiment
    {
