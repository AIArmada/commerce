...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create(config('ticketing.database.tables.ticket_type_products', 'ticket_ticket_type_products'), function (Blueprint $table) use ($jsonType): void {
    ...
    {
        Schema::dropIfExists(config('ticketing.database.tables.ticket_type_products', 'ticket_ticket_type_products'));
    }
};
