...
use AIArmada\FilamentEvents\Resources\OccurrenceResource\Schemas\OccurrenceForm;
use AIArmada\FilamentEvents\Resources\OccurrenceResource\Schemas\OccurrenceInfolist;
use AIArmada\FilamentEvents\Resources\OccurrenceResource\Tables\OccurrenceTable;
use BackedEnum;
...
final class OccurrenceResource extends Resource
{
    ...
    {
        return OccurrenceForm::formSchema(includeEventField: $includeEventField);
    }

    public static function table(Table $table): Table
    {
        return OccurrenceTable::configure($table);
    }
